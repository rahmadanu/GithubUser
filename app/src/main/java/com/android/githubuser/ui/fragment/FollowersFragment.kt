...
class FollowersFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        followViewModel.hasNoFollowers.observe(viewLifecycleOwner) {
            showNoData(it)
        }

        followViewModel.findUserFollowers(username)
        followViewModel.getFollowersUser().observe(viewLifecycleOwner) {
            if (it != null) {
